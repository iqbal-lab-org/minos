...
class TestUtils(unittest.TestCase):
    ...
    def test_remove_vars_from_vcf_at_contig_ends(self):
        ...
        expect_vcf = os.path.join(data_dir, "remove_vars_from_vcf_at_contig_ends.expect.vcf")
        ...
        utils.remove_vars_from_vcf_at_contig_ends(vcf_out, vcf_out, ref_lengths=ref_lengths)
