...
class TestVcfFileSplitDeletions(unittest.TestCase):
    def test_run(self):
        ...
        splitter = vcf_file_split_deletions.VcfFileSplitDeletions(infile, out_small, out_big, min_large_ref_length=5)
        splitter.run()
        ...
        splitter = vcf_file_split_deletions.VcfFileSplitDeletions(infile, out_small, out_big, min_large_ref_length=10)
        splitter.run()
